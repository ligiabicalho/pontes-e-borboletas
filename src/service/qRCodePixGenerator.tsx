...
export default class QRCodePixGeneratorService implements IQRCodePixGeneratorService {
  constructor(private version: string){}

  async generate(params: IQRCodePixGeneratorParams): Promise<IQRCodePixGeneratorResponse> {
